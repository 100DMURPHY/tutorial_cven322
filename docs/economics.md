...
## Incremental IRR
Analyze the difference between two projects ($\Delta CF = CF_B - CF_A$) to justify additional investment. If the incremental IRR is greater than the MARR, the more expensive project is preferred.
